...
describe 'A movie' do
  ...
  it 'requires a title' do
    ...
    expect(movie.errors[:title].any?).to be_truthy
  end
  ...
  it 'requires a description' do
    ...
    expect(movie.errors[:description].any?).to be_truthy
  end
  ...
  it 'requires a released on date' do
    ...
    expect(movie.errors[:released_on].any?).to be_truthy
  end
  ...
  it 'requires a duration' do
    ...
    expect(movie.errors[:duration].any?).to be_truthy
  end
