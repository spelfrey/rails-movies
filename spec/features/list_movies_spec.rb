...
describe 'Viewing the list of events' do
  ...
  it 'shows Flop! if total gross is less than $50 million' do
  ...
  it 'formats released dates as Month DD, YY' do
    movie = Movie.create(movie_attributes(released_on: '2008-05-02'))
